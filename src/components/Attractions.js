        ...
        <div>
            <div className="attractions">
                <header className="attractions-header">
                    <img src="attractions.jpg" alt="Attractions" className="attractions-image" />
                    <h1>Attractions</h1>
                </header>
                ...
                <section className="explore-areas">
                    ...
                    <div className="area-cards">
                        <div className="area-card">
                            <img src="diamond-beach.jpg" alt="Diamond Beach" />
                            <h3>DIAMOND BEACH</h3>
                        ...
                        <div className="area-card">
                            <img src="kelingking-beach.jpg" alt="Kelingking Beach" />
                        ...
                        <div className="area-card">
                            <img src="sekumpul.jpg" alt="Sekumpul" />
                            <h3>SEKUMPUL</h3>
